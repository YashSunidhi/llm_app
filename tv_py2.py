...
def image_gen():
    ...
    (""))
    prompt = f''' Can you write detailed description as instructions for 5 diverse images placeholders using artifacts like geneder, race, eye contact , body posture, facial expression,  light description, image background setting etc.  ensuring realism suitable for task text to image generation from context """  {option8} """. Assistant: \n\n'''
    response_o = []
