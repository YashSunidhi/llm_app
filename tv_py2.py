...
def image_gen():
    ...
    if on:
      ...
      with st.spinner("Thinking..."):
          image_bytes = query({
              "inputs": default_prompt[0] + " Intricately Detailed, High Quality, photorealistic, portrait photography, Full Character, detailed, street photography, dramatic lighting ",
